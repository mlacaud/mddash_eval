...
echo nbprofiles $nbprofiles
  echo 'NetworkProfiles mddash_9S_200 mddash_9S_400 mddash_9S_1M mddash_9S_1M6 mddash_9S_2M mddash_9S_3M mddash_9S_4M mddash_9S_6M' > parsed/percentq2out.txt
  ...
  do
    ...
    do
      ...
      do
        ...
        tools/parsing_logs_bash.sh ${file1} ${file2} ${file3} tmp.txt mddash
